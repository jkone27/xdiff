...
type DifferenceExtension =
    ...
    [<Extension>]
    static member Difference(first: System.String, second: System.String, excludedNodes: IEnumerable<System.String>) =
        FilesDiff(first, second, excludedNodes, defaultLoad)

    [<Extension>]
    static member Difference(first: System.String, second: System.String, fileLoader: System.String -> XElement) =
